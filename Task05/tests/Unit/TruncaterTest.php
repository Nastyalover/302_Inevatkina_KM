...
class TruncaterTest extends TestCasep
{
    ...
    public function Reduction()
    {
        ...
        $this->assertSame('Иневаткина...', $truncater->truncate('Иневаткина Ксения Михайловна', ['length' => 10]));
        ...
        $this->assertSame('Иневаткин*', $truncater->truncate('Иневаткина Ксения Михайловна', ['length' => 10, 'separator' => '*']));
